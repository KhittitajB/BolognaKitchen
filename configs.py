...
meat_img = pygame.image.load("assets/meat.png")
veggie_img = pygame.image.load("assets/carrot.png")
grains_img = pygame.image.load("assets/bread.png")
dairy_img = pygame.image.load("assets/dairy-products.png")
