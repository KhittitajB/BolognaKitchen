...
meat_img = pygame.image.load("assets/minecraft_pork.png")
veggie_img = pygame.image.load("assets/minecraft_carrot.png")
grains_img = pygame.image.load("assets/minecraft_wheat.png")
dairy_img = pygame.image.load("assets/minecraft_milk.png")

background = pygame.image.load("assets/kitchen.png")
...
draw_pile_img = pygame.image.load("assets/card_back.png")
